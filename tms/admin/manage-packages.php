...
{				?>		
						  <tr>
							...
							<td><a href="update-package.php?pid=<?php echo $result->PackageId;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="manage-packages.php?del=<?php echo $result->PackageId;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
