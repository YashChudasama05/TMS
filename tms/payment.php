...
$sql3="SELECT * FROM tblbooking WHERE BookingId=$bookid";
...
header('location:index.php');
	...
	$sql = "INSERT INTO card_payment(fullname,email,address,city,state,zipcode,nameoncard,cardnumber,expmonth,expyear,payment) VALUES('$fullname','$email','$address','$city','$state','$zipcode','$cardname','$cardnum','$expmonth','$expyear','$payment')";

	$result=mysqli_query($db,$sql);


	$sql2="UPDATE tblbooking SET pay=1 WHERE BookingId=$bookid";
...
Email : '.$email.'';
 ...
 $success = "Payment successful  <p>You will be redirected in <span id='counter'>5</span> second(s).</p>
                                                        ...
                                                        header("refresh:5;url=tour-history.php"); // redireted once inserted success
